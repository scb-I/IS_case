...
export default function Home() {
    ...
    const [currentSrc, setCurrentSrc] = useState(
        'https://user-images.githubusercontent.com/84803793/278491837-1dc0e88c-c2f5-44ae-a8ab-daa158bc7693.mp4'
                    ...
                    <div className='relative flex flex-col w-[260px] h-full bg-[#2B3033]'>
                        <div className='flex flex-col p-[15px] space-y-[10px] w-full h-auto'>
                            ...
                            <button
                                onClick={() =>
                                    changeSrcClick(
                                        'https://user-images.githubusercontent.com/84803793/278491813-10abd39a-9d4f-43e2-abb2-c7189cf33a33.mp4'
                                    )
                                }
                                className='button-cam'
                            >
