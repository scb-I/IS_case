...
# Model
model = torch.hub.load("ultralytics/yolov5фыа", "yolov5s")  # or yolov5n - yolov5x6, custom
...
model = torch.hub.load(
    "ultralytics/yolov5фыа", "custom", "yolov5m-seg.pt"
...
```python
model = torch.hub.load(
    "ultralytics/yolov5фыа", "custom", "yolov5s-cls.pt"
