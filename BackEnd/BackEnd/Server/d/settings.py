"""
Django settings for FastReportsServer project.
...
sys.path.append(os.path.join(os.path.dirname(__file__), 'd'))
...
WSGI_APPLICATION = 'FastReportsServer.wsgi.application'
